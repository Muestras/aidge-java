...
public class ImageBackGroundRemovalHttpExample {
    ...
    public static void main(String[] args) {
        try {
            ...
            json.put("imageUrl", "https://ae01.alicdn.com/kf/Sa78257f1d9a34dad8ee494178db12ec8l.jpg");
            json.put("backGroundType", "WHITE_BACKGROUND");
            String apiRequest = json.toString();
