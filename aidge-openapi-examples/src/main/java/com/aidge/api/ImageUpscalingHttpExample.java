...
public class ImageUpscalingHttpExample {
    ...
    public static void main(String[] args) {
        try {
            ...
            apiRequestJson.put("imageUrl", "https://ae-pic-a1.aliexpress-media.com/kf/Sac81d99346924838bd15689923c5f976E.jpg_960x960q75.jpg");
            apiRequestJson.put("upscaleFactor", 4);
